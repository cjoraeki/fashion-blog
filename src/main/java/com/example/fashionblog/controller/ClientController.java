...
public class ClientController {
    ...
    public ResponseEntity<ClientResponseDto> toRegisterAdmin(@RequestBody ClientSignUpDto clientSignUpDto){
        ClientResponseDto clientResponseDto = clientService.registerAClient(clientSignUpDto);
